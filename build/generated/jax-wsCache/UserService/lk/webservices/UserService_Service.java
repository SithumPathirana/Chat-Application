 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://webservices.lk/", wsdlLocation = "http://localhost:8080/ChatApplication2_WS/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://webservices.lk/", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ChatApplication2_WS/UserService?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://webservices.lk/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.lk/", "UserServicePort"), UserService.class, features);
    }
