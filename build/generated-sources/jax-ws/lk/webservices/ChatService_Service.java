 ...
 * 
 */
@WebServiceClient(name = "ChatService", targetNamespace = "http://webservices.lk/", wsdlLocation = "http://localhost:8080/ChatApplication2_WS/ChatService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CHATSERVICE_QNAME = new QName("http://webservices.lk/", "ChatService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ChatApplication2_WS/ChatService?wsdl");
    ...
    public ChatService getChatServicePort() {
        return super.getPort(new QName("http://webservices.lk/", "ChatServicePort"), ChatService.class);
    }
    ...
    public ChatService getChatServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.lk/", "ChatServicePort"), ChatService.class, features);
    }
