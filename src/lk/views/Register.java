...
public class Register extends javax.swing.JFrame {
   ...
   public static String re_password;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Chat Registration");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(WebClient.register(password, re_password)){
           if(WebClient.checkLoginId(loginID)){
                RegisterError regError=new RegisterError();
                regError.setVisible(true);
                this.dispose();
               
           }else{
                 Login.loginId=loginID;
                 WebClient.insertUser(nickName, loginID, password);
                  this.dispose();
               ChatThreads chats=new ChatThreads();
                chats.setVisible(true);
           } 
       }else{
       
           JOptionPane.showMessageDialog(this, "Passwords you entered does not match each other.","Password Check",JOptionPane.WARNING_MESSAGE);
       } 
