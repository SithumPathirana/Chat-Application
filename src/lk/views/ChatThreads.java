...
import javax.swing.*;
import lk.webservices.ChatThread;
...
public class ChatThreads extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Current Conversations");
    ...
    public void showChatThreads(){
        List<ChatThread> chatThreads=WebClient.getThreadData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChatThreads.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChatThreads().setVisible(true);
            }
        });
    }
